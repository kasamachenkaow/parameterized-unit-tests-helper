...
import { testsuite, testname, testcase, testcategory, beforeEach } from 'p-test-js/mocha'
...
export class TestCaseTest {
  ...
  happyPaths(args: unknown[], testId: string): void {
    ...
    const existingTests: TestData[] = Reflect.getOwnMetadata(testcaseMetadataKey, target.constructor) ?? []
