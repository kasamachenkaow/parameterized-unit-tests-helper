...
export const getScopeData = (scopeId: object): TestData[] | undefined => {
  const existingTests: TestData[] | undefined = Reflect.getOwnMetadata(testcaseMetadataKey, scopeId)
  return existingTests
}
export const getTestData = (scopeId: object, testId: string): TestData|undefined => {
...
export const putTestData = (scopeId: object, testId: string, testdata: TestData) => {
